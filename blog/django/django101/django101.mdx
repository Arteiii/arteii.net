...
<img src={./assets/python_download_site.png} width={450} alt="python download site image"/>

After the download is complete, run the installer. Make sure you check "add python.exe to PATH".

<img src={./assets/python_installer_add_to_path.png} width={450} alt="python download site iamge"/>
...
<img src={./assets/django_initial_setup.png} width={550} alt="python download site iamge"/>
