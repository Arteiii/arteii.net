...
from full-fledged ORM libraries to lightweight SQL query builders.
One of the most popular ORMs is **SeaORM**,
which comes with a rich set of features and _fantastic documentation_
to help you get started [here](https://www.sea-ql.org/SeaORM/docs/index/).
...
| ------------- | ----------------------------------------------------------------------------------------------- | --------------------------------------------------- |
| **SeaORM**    | Best for feature-rich, full ORM solutions with async capabilities and strong documentation.     | [SeaORM Docs](https://www.sea-ql.org/SeaORM/)       |
...
<CardSection id="database-index" title="Index">
  <Card
    title="SQLx"
    icon={<PiFileSqlThin />}
    to="/rust-cookbook/database/sqlx/"
