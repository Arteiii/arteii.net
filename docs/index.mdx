...
:::note
It is strongly recommended that the information used in this document be verified with others and that reference be made to recognized professional literature, scientific articles, or official sources.
...
<CardSection id="cheatsheet" title="CheatSheet's">
    ...
    <Card
        ...
        to="/docs/cheatsheets/ComputerArchitecture/"
